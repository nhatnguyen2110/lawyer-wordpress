...
class Team implements ShortcodeInterface
{
	...
	public function vcMap()	{
		...
		vc_map( array(
			'name' => esc_html__( 'Mikado Team', 'mikado-core' ),
			'base' => $this->base,
			...
			'params' => array_merge(
				array(
					...
					array(
						'type' => 'colorpicker',
						'heading' => esc_html__( 'Name Color', 'mikado-core' ),
					...
					array(
						'type' => 'colorpicker',
						'heading' => esc_html__( 'Position Color', 'mikado-core' ),
					...
					array(
						'type' => 'dropdown',
						'heading' => esc_html__( 'Show More Info', 'mikado-core' ),
					...
					array(
						'type' => 'textarea',
						'heading' => esc_html__( 'Description Title', 'mikado-core' ),
						'admin_label' => true,
						'save_always' => true,
						'value' => esc_html__('Biography', 'mikado-core' ),
					...
					array(
						'type' => 'colorpicker',
						'heading' => esc_html__( 'Description Color', 'mikado-core' ),
	...
	public function render($atts, $content = null)
	{
		...
		$html = mkd_core_get_core_shortcode_template_part('templates/team-template', 'team', '', $params);
