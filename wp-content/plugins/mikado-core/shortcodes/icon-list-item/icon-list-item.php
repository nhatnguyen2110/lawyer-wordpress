...
class IconListItem implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__( 'Mikado Icon List Item', 'mikado-core' ),
			'base' => $this->base,
			...
			'params' => array_merge(
				...
				array(
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__( 'Title Left Margin (px)', 'mikado-core' ),
	...
	public function render($atts, $content = null) {
		...
		$html = mkd_core_get_core_shortcode_template_part('templates/icon-list-item-template', 'icon-list-item', '', $params);
		return $html;
	}
	 /**
