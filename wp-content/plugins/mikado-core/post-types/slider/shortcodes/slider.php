...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if (get_post_meta($page_id, "mkd_page_hide_initial_sticky", true) == "yes"){
                ...
                while (have_posts()) : the_post();
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .='<object width="320" height="240" type="application/x-shockwave-flash" data="' . esc_url(get_template_directory_uri()) . '/js/flashmediaelement.swf">
													...
													<img src="' . esc_url($video_image) . '" width="1920" height="800" title="'.esc_attr__('No video playback capabilities','mikado-core').'" alt="'.esc_attr__('Video thumb','mikado-core').'" />
											</object>
									</video>
							</div></div>';
                    } else {
