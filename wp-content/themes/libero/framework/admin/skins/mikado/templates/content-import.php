        ...
        <div class="tab-pane fade in active" id="import">
            <div class="mkd-tab-content">
                <div class="mkd-page-title-holder clearfix">
                    <h2 class="mkd-page-title"><?php esc_html_e( 'Import', 'libero' ); ?></h2>
                </div>
                <form method="post" class="mkd_ajax_form mkd-import-page-holder">
                    <div class="mkd-page-form">
                        <div class="mkd-page-form-section-holder">
                            <h3 class="mkd-page-section-title"><?php esc_html_e( 'Import Demo Content', 'libero' ); ?></h3>
                            <div class="mkd-page-form-section">
                                <div class="mkd-field-desc">
                                    <h4><?php esc_html_e( 'Import', 'libero' ); ?></h4>

                                    <p><?php esc_html_e( 'Choose demo content you want to import', 'libero' ); ?></p>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_example" id="import_example" class="form-control mkd-form-element dependence">
                                                    <option value="libero"><?php esc_html_e( 'Libero', 'libero' ); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mkd-page-form-section">
                                ...
                                <div class="mkd-field-desc">
                                    <h4><?php esc_html_e( 'Import Type', 'libero' ); ?></h4>

                                    <p><?php esc_html_e( 'Enabling this option will switch to a Side Position (default is Top Position)', 'libero' ); ?></p>
                                </div>
                                <!-- close div.mkd-field-desc -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_option" id="import_option" class="form-control mkd-form-element">
                                                    <option value=""><?php esc_html_e( 'Please Select', 'libero' ); ?></option>
                                                    <option value="complete_content"><?php esc_html_e( 'All', 'libero' ); ?></option>
                                                    <option value="content"><?php esc_html_e( 'Content', 'libero' ); ?></option>
                                                    <option value="widgets"><?php esc_html_e( 'Widgets', 'libero' ); ?></option>
                                                    <option value="options"><?php esc_html_e( 'Options', 'libero' ); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mkd-page-form-section">
                                ...
                                <div class="mkd-field-desc">
                                    <h4><?php esc_html_e( 'Import attachments', 'libero' ); ?></h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <p class="field switch">
                                                    <label class="cb-enable dependence"><span><?php esc_html_e( 'Yes', 'libero' ); ?></span></label>
                                                    <label class="cb-disable selected dependence"><span><?php esc_html_e( 'No', 'libero' ); ?></span></label>
                            ...
                            <div class="mkd-page-form-section">
                                ...
                                <div class="mkd-field-desc">
                                    <input type="submit" class="btn btn-primary btn-sm " value="<?php esc_attr_e('Import','libero'); ?>" name="import" id="import_demo_data" />
                                </div>
                                <!-- close div.mkd-field-desc -->
                                <div class="mkd-section-content">
                                    <div class="container-fluid">
                                    ...
                                    if (p == 90) {
                                        ...
                                        jQuery.ajax({
                                            ...
                                            success: function(data, textStatus, XMLHttpRequest){
                                                ...
                                                $('.progress-value').html((p) + '%');
                                                progressbar.val(p);
                                                $('.progress-bar-message').html('<div class="alert alert-success"><strong><?php esc_html_e( 'Import is completed', 'libero' ); ?></strong></div>');
                                            },
                                            ...
                                            success: function(data, textStatus, XMLHttpRequest){
                                                jQuery.ajax({
                                                    ...
                                                    success: function(data, textStatus, XMLHttpRequest){
                                                        ...
                                                        $('.progress-value').html((100) + '%');
                                                        progressbar.val(100);
                                                        $('.progress-bar-message').html('<div class="alert alert-success"><?php esc_html_e( 'Import is completed.', 'libero' ); ?></div>');
                                                    },
                                                    error: function(MLHttpRequest, textStatus, errorThrown){
                                                    }
                                                });
