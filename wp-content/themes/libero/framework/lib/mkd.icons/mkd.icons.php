...
class LiberoIconCollections {
    ...
    public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false) {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading' => esc_html__( 'Icon pack', 'libero' ),
        ...
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $key => $collection) {
                $iconSetParams[] = array(
                    'type'        => 'dropdown',
                    'heading' => esc_html__( 'Icon', 'libero' ),
    ...
    public function enqueueStyles() {
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $collection_key => $collection_obj) {
                wp_enqueue_style('libero-mikado-'.$collection_key, $collection_obj->styleUrl);
            }
        }
    }
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
                ...
                print libero_mikado_get_module_part($iconsObject->getSearchIcon());
            }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
                ...
                print libero_mikado_get_module_part($iconsObject->getSearchClose());
            }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
            print libero_mikado_get_module_part($iconsObject->getSearchIconValue());
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
            print libero_mikado_get_module_part($iconsObject->getMenuSideIcon());
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
            print libero_mikado_get_module_part($iconsObject->getBackToTopIcon());
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
                ...
                print libero_mikado_get_module_part($iconsObject->getMobileMenuIcon());
            }
        }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
                ...
                print libero_mikado_get_module_part($iconsObject->getQuoteIcon());
            }
