...
if ( ! function_exists('libero_mikado_contact_form_7_options_map') ) {
	...
	function libero_mikado_contact_form_7_options_map() {
		...
		libero_mikado_add_admin_page(array(
			...
			'title' => esc_html__( 'Contact Form 7', 'libero' ),
			'icon'	=> 'icon_mail_alt'
		));
		...
		$panel_contact_form_style_1 = libero_mikado_add_admin_panel(array(
			...
			'title' => esc_html__( 'Custom Style 1', 'libero' )
		));
		...
		$typography_text_group = libero_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Form Text Typography', 'libero' ),
			'description' => esc_html__( 'Setup typography for form elements text', 'libero' ),
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Text Color', 'libero' ),
		));
		...
		$typography_label_group = libero_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Form Label Typography', 'libero' ),
			'description' => esc_html__( 'Setup typography for form elements label', 'libero' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		$background_border_group = libero_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Form Elements Background and Border', 'libero' ),
			'description' => esc_html__( 'Setup form elements background and border style', 'libero' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Background Transparency', 'libero' ),
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Background Color', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Background Transparency', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Transparency', 'libero' ),
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Border Color', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Focus Border Transparency', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Width', 'libero' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Radius', 'libero' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = libero_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title' => esc_html__( 'Elements Padding', 'libero' ),
			'description' => esc_html__( 'Setup form elements padding', 'libero' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Padding Top', 'libero' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Padding Bottom', 'libero' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = libero_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title' => esc_html__( 'Elements Margin', 'libero' ),
			'description' => esc_html__( 'Setup form elements margin', 'libero' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Margin Top', 'libero' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Margin Bottom', 'libero' ),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Textarea Height', 'libero' ),
			'description' => esc_html__( 'Enter height for textarea form element', 'libero' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = libero_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Button Typography', 'libero' ),
			'description' => esc_html__( 'Setup button text typography', 'libero' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		$button_background_border_group = libero_mikado_add_admin_group(array(
			...
			'title' => esc_html__( 'Button Background and Border', 'libero' ),
			'description' => esc_html__( 'Setup button background and border style', 'libero' ),
			'parent'		=> $panel_contact_form_style_1
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Background Hover Color', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Background Hover Transparency', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Hover Color', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Border Hover Transparency', 'libero' )
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Button Height', 'libero' ),
			'description' => esc_html__( 'Insert form button height', 'libero' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		libero_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label' => esc_html__( 'Button Left/Right Padding', 'libero' ),
			'description' => esc_html__( 'Enter value for button left and right padding', 'libero' ),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = libero_mikado_add_admin_panel(array(
			...
			'title' => esc_html__( 'Custom Style 2', 'libero' )
		));
		...
		$panel_contact_form_style_3 = libero_mikado_add_admin_panel(array(
			...
			'title' => esc_html__( 'Custom Style 3', 'libero' )
		));
