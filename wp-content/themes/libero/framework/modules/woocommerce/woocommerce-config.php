...
if(libero_mikado_core_installed()) {
	//Apply Coupon Button
	add_action(
		'libero_mikado_woocommerce_apply_coupon_button',
		'libero_mikado_get_woocommerce_apply_coupon_button'
	);
}
if(libero_mikado_core_installed()) {
	//Update Cart
	add_action(
		'libero_mikado_woocommerce_update_cart_button',
		'libero_mikado_get_woocommerce_update_cart_button'
	);
}
...
if(libero_mikado_core_installed()) {
	...
	add_action(
		'woocommerce_proceed_to_checkout',
		'libero_mikado_woocommerce_button_proceed_to_checkout',
		20
	);
}
...
if(libero_mikado_core_installed()) {
	...
	add_filter(
		...
		'libero_mikado_woocommerce_order_button_html'
	);
}
