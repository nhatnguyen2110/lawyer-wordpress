...
if (!function_exists('libero_mikado_get_woocommerce_add_to_cart_button')) {
	...
	function libero_mikado_get_woocommerce_add_to_cart_button() {
		...
		if(libero_mikado_core_installed()) {
			$add_to_cart_button = libero_mikado_get_button_html(
				array(
			...
			$add_to_cart_button = '<button type="submit" class="mkd-btn mkd-btn-medium mkd-btn-solid mkd-btn-icon single_add_to_cart_button alt">';
			$add_to_cart_button .= '<span class="mkd-btn-text">'.$product->single_add_to_cart_text().'</span>';
			$add_to_cart_button .= '<span class="mkd-btn-icon-holder"><span class="mkd-icon-font-elegant arrow_carrot-right mkd-btn-icon-elem"></span><span class="mkd-icon-font-elegant arrow_carrot-right mkd-btn-icon-elem"></span></span></button>';
		}

		print libero_mikado_get_module_part($add_to_cart_button);
...
if (!function_exists('libero_mikado_get_woocommerce_add_to_cart_button_external')) {
	...
	function libero_mikado_get_woocommerce_add_to_cart_button_external() {
		...
		if(libero_mikado_core_installed()) {
			...
			$add_to_cart_button = '<a href="'.$product->add_to_cart_url().'" class="mkd-btn mkd-btn-medium mkd-btn-solid mkd-btn-icon single_add_to_cart_button alt" rel="nofollow">';
			$add_to_cart_button .= '<span class="mkd-btn-text">'.$product->single_add_to_cart_text().'</span>';
			$add_to_cart_button .= '<span class="mkd-btn-icon-holder"><span class="mkd-icon-font-elegant arrow_carrot-right mkd-btn-icon-elem"></span><span class="mkd-icon-font-elegant arrow_carrot-right mkd-btn-icon-elem"></span></span></a>';
		}
...
if ( ! function_exists('libero_mikado_woocommerce_single_variation_add_to_cart_button') ) {
	...
	function libero_mikado_woocommerce_single_variation_add_to_cart_button() {
		...
		if(libero_mikado_core_installed()) {
			$button = libero_mikado_get_button_html(
				array(
					'html_type'    => 'button',
					'custom_class' => 'single_add_to_cart_button alt',
					'text'         => $product->single_add_to_cart_text()
			...
			$button = '<button type="submit" class="mkd-btn mkd-btn-medium mkd-btn-solid mkd-btn-icon single_add_to_cart_button alt disabled wc-variation-selection-needed"><span class="mkd-btn-text">'.$product->single_add_to_cart_text().'</span><span class="mkd-btn-icon-holder"><span class="mkd-icon-font-elegant arrow_carrot-right mkd-btn-icon-elem"></span><span class="mkd-icon-font-elegant arrow_carrot-right mkd-btn-icon-elem"></span></span></button>';
		}
...
if (!function_exists('libero_mikado_get_woocommerce_apply_coupon_button')) {
	...
	function libero_mikado_get_woocommerce_apply_coupon_button() {
		...
		print libero_mikado_get_module_part($coupon_button);
...
if (!function_exists('libero_mikado_get_woocommerce_update_cart_button')) {
	...
	function libero_mikado_get_woocommerce_update_cart_button() {
		...
		print libero_mikado_get_module_part($update_cart_button);
...
if (!function_exists('libero_mikado_woocommerce_button_proceed_to_checkout')) {
	...
	function libero_mikado_woocommerce_button_proceed_to_checkout() {
		...
		print libero_mikado_get_module_part($proceed_to_checkout_button);
...
if (!function_exists('libero_mikado_get_woocommerce_update_totals_button')) {
	...
	function libero_mikado_get_woocommerce_update_totals_button() {
		...
		print libero_mikado_get_module_part($update_totals_button);
