    ...
    function libero_mikado_woocommerce_assets() {
        ...
        if(libero_mikado_is_woocommerce_installed()) {
            if(libero_mikado_load_woo_assets()) {
                ...
                wp_enqueue_style('libero-mikado-woocommerce', MIKADO_ASSETS_ROOT.'/css/woocommerce.min.css');

                //is responsive option turned on?
                if(libero_mikado_options()->getOptionValue('responsiveness') == 'yes') {
                    //include theme's woocommerce responsive styles
                    wp_enqueue_style('libero-mikado-woocommerce-responsive', MIKADO_ASSETS_ROOT.'/css/woocommerce-responsive.min.css');
                }
            }
        }
    }
