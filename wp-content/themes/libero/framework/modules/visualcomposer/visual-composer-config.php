...
if ( ! function_exists('libero_mikado_vc_row_map') ) {
	...
	function libero_mikado_vc_row_map()
	{
		...
		$animations = array(
			esc_html__('No animation', 'libero' ) => '',
			esc_html__('Elements Shows From Left Side', 'libero' ) 	=>	'mkd-element-from-left',
			esc_html__('Elements Shows From Right Side', 'libero' )	=> 	'mkd-element-from-right',
			esc_html__('Elements Shows From Top Side', 'libero' )		=>	'mkd-element-from-top',
			esc_html__('Elements Shows From Bottom Side', 'libero' )	=>	'mkd-element-from-bottom',
			esc_html__('Elements Shows From Fade', 'libero' )			=>	'mkd-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Row Type', 'libero' ),
			'param_name' => 'row_type',
			'value' => array(
				esc_html__('Row', 'libero' ) => 'row',
				esc_html__('Parallax', 'libero' ) => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Content Width', 'libero' ),
			'param_name' => 'content_width',
			'value' => array(
				esc_html__('Full Width', 'libero' ) => 'full-width',
				esc_html__('In Grid', 'libero' ) => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Header Style', 'libero' ),
			'param_name' => 'header_style',
			'value' => array(
				esc_html__('Default', 'libero' ) => '',
				esc_html__('Light', 'libero' ) => 'mkd-light-header',
				esc_html__('Dark', 'libero' ) => 'mkd-dark-header'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__( 'Anchor ID', 'libero' ),
			'param_name' => 'anchor',
			'value' => '',
			'description' => esc_html__( 'For example home', 'libero' )
		));
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Content Aligment', 'libero' ),
			'param_name' => 'content_aligment',
			'value' => array(
				esc_html__('Left', 'libero' ) => 'left',
				esc_html__('Center', 'libero' ) => 'center',
				esc_html__('Right', 'libero' ) => 'right'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Video Background', 'libero' ),
			'value' => array(
				esc_html__('No', 'libero' ) => '',
				esc_html__('Yes', 'libero' ) => 'show_video'
			),
			'param_name' => 'video',
			'description' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Video Overlay', 'libero' ),
			'value' => array(
				esc_html__('No', 'libero' ) => '',
				esc_html__('Yes', 'libero' ) => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__( 'Video Overlay Image (pattern)', 'libero' ),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__( 'Video Background (webm) File URL', 'libero' ),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__( 'Video Background (mp4) file URL', 'libero' ),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__( 'Video Background (ogv) file URL', 'libero' ),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__( 'Video Preview Image', 'libero' ),
			'value' => '',
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Full Screen Height', 'libero' ),
			'param_name' => 'full_screen_section_height',
			'value' => array(
				esc_html__('No', 'libero' ) => 'no',
				esc_html__('Yes', 'libero' ) => 'yes'
			),
			'save_always' => true,
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__( 'Vertically Align Content In Middle', 'libero' ),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__( 'Section Height', 'libero' ),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__( 'Parallax Background image', 'libero' ),
			'value' => '',
			'param_name' => 'parallax_background_image',
			'description' => esc_html__( 'Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'libero' ),
			'dependency' => Array('element' => 'row_type', 'value' => array('parallax'))
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__( 'Parallax speed', 'libero' ),
        ...
        vc_add_param("vc_row", array(
            "type" => "dropdown",
            "class" => "",
            "heading" => esc_html__( "Triangle Shape in Background", 'libero' ),
            ...
            "save_always" => true,
            "description" => esc_html__( "Enabling this option will display a triangular shape on the row", 'libero' ),
            "dependency" => Array('element' => "row_type", 'value' => array('row', 'parallax'))
        ));
        ...
        vc_add_param("vc_row", array(
            "type" => "dropdown",
            "class" => "",
            "heading" => esc_html__( "Triangle Shape Position", 'libero' ),
            "param_name" => "triangle_shape_position",
            "value" => array(
	            esc_html__('Default (both)', 'libero' ) => 'both',
	            esc_html__('Only Top', 'libero' ) => 'top',
	            esc_html__('Only Bottom', 'libero' ) => 'bottom'
            ),
            "save_always" => true,
            "description" => "",
        ...
        vc_add_param("vc_row", array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => esc_html__( "Triangle Shape Color", 'libero' ),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'CSS Animation', 'libero' ),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__( 'Transition delay (ms)', 'libero' ),
        ...
        vc_add_param('vc_row_inner', array(
            'type' => 'textfield',
            'class' => '',
            'heading' => esc_html__( 'Row Overlap - Top (px)', 'libero' ),
            'param_name' => 'overlap_top',
            'value' => '',
            'description' => esc_html__( 'Enter the amount of pixels you would like this row to overlap the row above it', 'libero' )
        ));

        vc_add_param('vc_row_inner', array(
            'type' => 'textfield',
            'class' => '',
            'heading' => esc_html__( 'Row Overlap - Bottom (px)', 'libero' ),
            'param_name' => 'overlap_bottom',
            'value' => '',
            'description' => esc_html__( 'Enter the amount of pixels you would like this row to overlap the row below it', 'libero' )
        ));
	}
